...
public class LockOpen {
    public final static String START = "0000";
    public int openLock(String[] deadends, String target) {

       Set<String> D = Set.of(deadends);
       ...
       Q.add(START);
       //int tar = new Integer(target);
       while (!Q.isEmpty()) {
           String cCurr = Q.poll();
           int count = V[new Integer(cCurr)]+1;
           Set<String> childs = getChildren(cCurr);
           for(String i : childs) {
               int ii = new Integer(i);
               if ((V[ii] > 0) || D.contains(i)) continue;
               if (target.equals(i)) return count;
               V[ii] = count;
               Q.add(i);
           }
       }
    ...
    private Set<String> getChildren(String s) {
    ...
    public static void main(String[] args) {
        LockOpen lc = new LockOpen();
        String[] D = {"0201","0101","0102","1212","2002"};
        System.out.println(lc.openLock(D,"0202"));
    }
}
