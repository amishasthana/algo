...
/*
The basic idea is same. The differences are:
   a) Not allowing leading zero.
   b) Calculating total digits apriori and calculating diffs.
   c) Also math power removed.
 */
public class VerbalAirtmematicFaster {
    ...
    public static void main(String[] args) {
        String[] sArr2 = {"LEET", "CODE"};  //"POINT"     fa
        String[] sArr1 = {"SEND","MORE"};   //MONEY       tru
        VerbalAirthemtaic vab = new VerbalAirthemtaic();
        //vab.test(sArr,"MONEY");
        System.out.println(vab.isSolvable(sArr1,"MONEY"));
